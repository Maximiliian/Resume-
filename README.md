...
Изучаю Machine Learning и современные AI-инструменты.  
Разработал ML-модель на Python для предсказания цены на основе линейной регрессии.  
В разработке использую GitHub Copilot, ChatGPT, Gemini, Claude и Codeium для ускорения работы и генерации кода.
